...
//
//     loadout_equip_module data = nlohmann::json::parse(jsonString);
...
namespace hue {
    ...
    struct loadout_equip_module {
        int64_t loadout_equip_module_class;
        std::string event;
        int64_t loadout_id;
...
namespace hue {
    void from_json(const json & j, loadout_equip_module & x);
    void to_json(json & j, const loadout_equip_module & x);

    inline void from_json(const json & j, loadout_equip_module& x) {
        x.loadout_equip_module_class = j.at("Class").get<int64_t>();
    ...
    inline void to_json(json & j, const loadout_equip_module & x) {
        j = json::object();
        j["Class"] = x.loadout_equip_module_class;
        j["event"] = x.event;
