...
//
//     carrier_ship_pack data = nlohmann::json::parse(jsonString);
...
namespace hue {
    void from_json(const json & j, carrier_ship_pack & x);
    void to_json(json & j, const carrier_ship_pack & x);

    inline void from_json(const json & j, carrier_ship_pack& x) {
    ...
    inline void to_json(json & j, const carrier_ship_pack & x) {
        j = json::object();
